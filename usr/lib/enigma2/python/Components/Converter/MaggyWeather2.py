...
config.plugins.NfrHD.woeid = ConfigNumber(default = "667931")
...
class MaggyWeather2(Converter, object):
...
class WeatherData:
	...
	def GetWeather(self):
		...
		if timeout > 0:
			...
			url = "http://query.yahooapis.com/v1/public/yql?q=select%20*%20from%20weather.forecast%20where%20woeid%3D%22"+str(config.plugins.NfrHD.woeid.value)+"%22&format=xml"
